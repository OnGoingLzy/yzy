		...
		<view class="sort-right"> 
			<view style="display: flex;width: 100%;justify-content: center;">
				<view class="first-category-box">
					<text v-text="categoryTitle" style="color: #fff; text-shadow: 4px 4px 4px rgba(0, 0, 0, 0.15);"></text>
				</view>
			</view>
...
export default{
	...
	onLoad: function (option) {
		...
		if(option && option.id){
			...
			this.categoryTitle = JSON.parse(decodeURIComponent(option.categoryName));
