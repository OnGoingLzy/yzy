		...
		<!-- <image class="bg-img" src='../../static/img/background1.jpg'></image> --> 
			...
			>
				...
				<view class='item-main' style="justify-content: flex-end;"> 
					<view class='active-icon' style="margin-right: 20px;" @tap='updateAddress(item)'>编辑</view>
...
export default {
  ...
  onUnload() {
  	  uni.$emit('pageClosedAddress', 'Success');
	  console.log('pageClosedAddress: FromPathList');
  },
};
</script>
